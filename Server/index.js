...
const create = [
  ...
  'CREATE TABLE IF NOT EXISTS cars(id SERIAL PRIMARY KEY, created_on TIMESTAMP, state VARCHAR (20), price FLOAT, manufacturer VARCHAR (20), model VARCHAR (20), body_type VARCHAR (20), img_url VARCHAR (20))',
